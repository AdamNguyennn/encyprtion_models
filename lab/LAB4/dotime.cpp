...
int main()
{
    ...
    case 1:
    {
        ...
        wcout << "[-] Average time taken for encrypt: " << double(sum / 10000) << " miliseconds" << endl;
        StringSource s(cipher, true, new FileSink("cipher.txt"));
    ...
    default:
    {
        ...
        wcout << "[-] Average time taken for decrypt: " << double(sum / 10000) << " miliseconds" << endl;
...
string GetInput(int is)
{
    ...
    if(is == 1)
    {
        FileSource file("input.txt", true, new StringSink(input));
        return input;
    }
    else 
    {
        FileSource file("cipher.txt", true, new StringSink(input));
        return input;
    }
}
