...
int main(int argc, char** argv)
{
	...
	try
	{
		...
		SavePrivateKey("rsa-private_1.key", rsaPrivate);
		SavePublicKey("rsa-public_1.key", rsaPublic);
		...
		SavePrivateKey("dsa-private_1.key", dsaPrivate);
		SavePublicKey("dsa-public_1.key", dsaPublic);
