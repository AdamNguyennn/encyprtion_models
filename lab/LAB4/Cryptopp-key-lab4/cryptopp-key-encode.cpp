...
int main(int argc, char** argv)
{
	...
	try
	{
		...
		EncodePrivateKey("rsa-private_1.key", rsaPrivate);
		EncodePublicKey("rsa-public_1.key", rsaPublic);				
		...
		RSA::PrivateKey k1;
		DecodePrivateKey("rsa-private_1.key", k1);

		RSA::PublicKey k2;
		DecodePublicKey("rsa-public_1.key", k2);
